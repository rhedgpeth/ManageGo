...
namespace ManageGo.Droid.Extensions
{
    public static class FontExtensions
    {
        static readonly Dictionary<Tuple<string, FontAttributes>, Typeface> _typefaces = new Dictionary<Tuple<string, FontAttributes>, Typeface>();
