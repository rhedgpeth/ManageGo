...
namespace ManageGo.iOS.Controls
{
    ...
    public class RadioButtonView : UIButton
    {
        ...
        void ApplyStyle()
        {
            this.SetImage(UIImage.FromBundle("radio_selected.png"), UIControlState.Selected);
            this.SetImage(UIImage.FromBundle("radio_unselected.png"), UIControlState.Normal);
        }
    }
}
